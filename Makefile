...
commit_txt = "($(shell $(thisdir_caps))) $(shell [[ -n $(mod_files) ]] && echo "🍩 Update $(mod_files)") $(shell [[ -n $(rnm_files) ]] && echo "🍩 Rename $(mod_files)") $(shell [[ -n $(add_files) ]] && echo "🍩 Adding $(add_files)") $(shell [[ -n $(del_files) ]] && echo "🍩 Delete $(del_files)")"
